...
class ReportPartnerLedger(models.AbstractModel):
    ...
    def _sum_partner_custom(self, partner, data):
        ...
        total_debit = sum(partner_data.mapped('debit'))
        total_credit = sum(partner_data.mapped('credit'))
    ...
    def _get_report_values(self, docids, data=None):
        ...
        return {
            ...
            'get_data_custom': self._get_data_custom,
            'sum_partner_custom': self._sum_partner_custom,
        }
